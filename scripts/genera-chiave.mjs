...
console.log("  Una variabile di tipo Secret però arriva al runtime con il nome");
console.log("  presente e il VALORE VUOTO: il portale la vede come mancante e");
console.log("  rifiuta di conservare credenziali, senza che nulla sembri rotto.");
console.log("");
console.log("  «Config» non vuol dire pubblica: resta visibile solo a chi ha");
console.log("  accesso al progetto Vercel. Una chiave che non arriva non protegge");
console.log("  nulla, blocca soltanto il portale.");
console.log("");
