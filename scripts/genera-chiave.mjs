...
console.log("");
console.log("  Type:         Config   <-- NON «Secret», vedi la nota qui sotto");
console.log("  Key:          SECRETS_KEY");
console.log("  Environments: Production, Preview, Development");
console.log("");
console.log("  Vercel propone «Secret» per le chiavi, e sembra la scelta giusta:");
console.log("  la sua descrizione nomina proprio «passwords, API keys, tokens».");
console.log("  Una variabile Secret però raggiunge il processo con il nome");
console.log("  presente e il VALORE VUOTO. Accertato per misura, non per");
console.log("  supposizione: nessuna forma di lettura la trova.");
console.log("");
console.log("  «Config» non vuol dire pubblica: resta visibile a chi ha accesso");
console.log("  al progetto Vercel. Una chiave che non arriva non protegge nulla,");
console.log("  blocca soltanto il portale.");
console.log("");
