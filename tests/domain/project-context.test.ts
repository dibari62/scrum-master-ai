...
describe("calendario lavorativo del progetto", () => {
  it("un contesto nuovo lavora luned�-venerd�, senza festivit�", () => {
    /*
     * L'unico predefinito onesto.
     *
     * � ci� che i dati sintetici gi� assumono, quindi adottarlo non cambia
     * nessun numero gi� mostrato. Inventare invece le festivit� di un paese che
     * nessuno ha dichiarato produrrebbe una capacit� sbagliata con l'aria di
  ...
  it("accetta una settimana diversa e le festivit� dichiarate", () => {
    const context = createProjectContextInputSchema.parse({
      workingCalendar: {
